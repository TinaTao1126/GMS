...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="contact" value="<?php echo ($data["contact"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">联系人电话</label>
            <div class="controls">
                <input type="text" class="text input-large" name="contact_number" value="<?php echo ($data["contact_number"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">备注</label>
            <div class="controls">
                <textarea class="textarea input-large" name="remark"><?php echo ($data["remark"]); ?></textarea>
            </div>
        </div>
        <div class="form-item">
